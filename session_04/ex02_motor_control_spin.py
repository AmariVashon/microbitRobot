...
def spinRight(speed):
    # spins wheels in opposite directions to make robot spin in place clockwise
    # speed: byte, motor spin speed.  0 is stopped, 255 is max speed.
    i2c.write(ADDR_MOTOR_CNTRL,bytearray([0,DIR_FORWARD,speed,DIR_BACKWARD,speed]))

def spinLeft(speed):
    # spins wheels in opposite directions to make robot spin in place counterclockwise
    # speed: byte, motor spin speed.  0 is stopped, 255 is max speed.
    i2c.write(ADDR_MOTOR_CNTRL,bytearray([0,DIR_BACKWARD,speed,DIR_FORWARD,speed]))

# demonstrate commands
spinRight(100)  # spin clockwise 
sleep(2000)     # spin for 2 seconds
stop()          # stop moving
sleep(1000)     # allow 1 second for robot to stop
spinLeft(100)   # spin counterclockwise
sleep(2000)     # spin for 2 seconds
stop()          # stop moving
sleep(1000)     # allow 1 second for robot to stop
